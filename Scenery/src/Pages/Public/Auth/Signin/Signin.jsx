            ...
            <div className="w-full h-[75dvh] flex justify-center items-center pb-70">
                {isSigninEmailValid ?
                    <div className="h-full flex flex-col gap-2 justify-start items-start">
                        ...
                        <button onClick={() => validateSigninPassword(typedSigninPassword, typedSigninEmail)} className="w-[clamp(100%,40vw,480px)] px-5 py-3 rounded-sm text-base bg-uicolor-primary font-medium 350:w-[clamp(300px,50vw,480px)] cursor-pointer transition duration-100 ease-out active:scale-[0.95]">Sign in</button>
                    ...
                    <div className="h-full flex flex-col gap-2 justify-start items-start">
                        ...
                        <button onClick={() => validateSigninEmail(typedSigninEmail)} className="w-[clamp(100%,40vw,480px)] px-5 py-3 rounded-sm text-base bg-uicolor-primary font-medium 350:w-[clamp(300px,50vw,480px)] cursor-pointer transition duration-100 ease-out active:scale-[0.95]">Continue</button>
