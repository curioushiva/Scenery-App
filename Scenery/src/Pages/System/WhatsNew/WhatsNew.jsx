      ...
      <div className="w-full flex flex-col gap-10">
        ...
        <div className="flex flex-col gap-4">
          ...
          <p className="text-base font-regular leading-relaxed text-textcolor-secondary lg:text-lg">
            Welcome to What's New, where you'll discover the latest features,
            improvements, and updates added to Scenery, keeping your
            entertainment experience evolving.
          </p>
        </div>
            ...
            return (
              <div className="flex flex-col gap-1">
                <div
                  ...
                  className={`w-full flex justify-between items-center gap-5 py-2 px-5 border border-white/10 rounded-2xl cursor-pointer transition-all ease-in duration-100 ${aboutQueType === update.id ? "bg-bgcolor-ternary/80" : "bg-white/1"}`}
                >
                  <div className="flex flex-col gap-1 350:flex-row 350:justify-center 350:items-center">
                    ...
                    <h2 className="text-xs font-regular lg:text-sm text-nowrap italic">
                      ({update.time})
                    </h2>
                  </div>
                ...
                {aboutQueType === update.id && (
                  <div className="py-5 px-5">
                    <h1 className="text-sm text-textcolor-secondary font-regular lg:text-base">
                      {update.updation}
                    </h1>
                  </div>
                )}
