    ...
    <div className="w-full bg-gradient-to-b from-[#431518] to-[#000000] p-8 pt-13 lg:px-35">
      <div className="w-full flex flex-col gap-10">
              ...
              return (
                <div className="flex flex-col gap-1">
                  <div
                    ...
                    className="w-full flex justify-between items-center gap-5 py-6 px-5 bg-bgcolor-ternary/80"
                  >
        ...
        <div className="flex flex-col gap-10">
          ...
          <span className="text-sm font-regular text-textcolor-secondary italic">
