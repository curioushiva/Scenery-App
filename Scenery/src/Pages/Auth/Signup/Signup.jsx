        ...
        <div className="w-full bg-gradient-to-b from-[#431518] to-[#000000] p-8 pt-13">
            <div className="w-full h-[75dvh] flex justify-center items-center pb-85">
                <div className="h-full flex flex-col gap-2 justify-start items-start">
                    ...
                    <button onClick={() => validateSignupCred(typedSignupEmail, typedSignupPassword)} className="w-[clamp(100%,40vw,480px)] px-5 py-3 rounded-sm text-base bg-uicolor-primary font-medium xs:w-[clamp(300px,50vw,480px)] cursor-pointer transition duration-100 ease-out active:scale-[0.95]">Sign up</button>
