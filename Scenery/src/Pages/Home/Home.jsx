        ...
        <div className="w-full bg-gradient-to-b from-[#431518] to-[#000000] flex flex-col gap-15 py-10 px-8 lg:px-35 overflow-x-hidden">
            ...
            <div className="max-w-2xl mx-auto flex flex-col justify-center items-center text-center gap-5 py-15">
                ...
                <div className="w-full flex flex-col gap-4 items-center md:flex-row md:items-start">
                    <div className="w-full flex flex-col gap-2 items-start">
                        ...
                        <p className="mt-1 text-sm text-uicolor-primary">{upperInvalidEmail}</p>
                    </div>
                    <div onClick={() => validateUpperEmail(upperTypedEmail)} className="w-45 md:w-60 py-3 flex justify-center items-center rounded-sm text-base bg-uicolor-primary font-medium cursor-pointer transition duration-100 ease-out active:scale-[0.95]">
                        <h1>Get Started</h1>
                        <RiArrowRightSLine />
                    </div>
                </div>
            ...
            < div className="w-full flex flex-col gap-5 sm:items-center" >
                ...
                < div className="w-full flex flex-col items-start gap-3 sm:flex-row lg:max-w-3xl" >
                    ...
                    <div onClick={() => validateLowerEmail(lowerTypedEmail)} className="flex w-42 sm:w-60 py-3 justify-center rounded-sm text-base bg-uicolor-primary font-medium cursor-pointer transition duration-100 ease-out active:scale-[0.95]">
                        <h1>Get Started</h1>
                        <RiArrowRightSLine />
                    </div>
                </div >
