...
const Search = () => {
  ...
  /* To set query on first render from redux */
  useEffect(() => {
              ...
              {!selectedResult.length > 0 && (
                <div className="row-start-2 col-start-1 w-full flex items-center justify-center">
                  <div className="max-w-xs flex flex-col items-center gap-4">
                    <div className="w-fit flex items-center justify-center p-3 bg-bg-cardcolor rounded-xl border border-br-primary/30">
                ...
                <div className="w-full row-start-2 col-start-1 z-10 ">
                  <div className="w-full flex flex-col border border-br-primary/30 rounded-sm divide-y divide-br-primary/30 bg-cardColor-secondary">
                    ...
                    >
                      ...
                      <h2 className="text-[10px] 280:text-xs font-regular text-text-fifth/80">
                        All results
                      </h2>
                    </div>
                  </div>
                ...
                <div className="w-full flex justify-between items-center gap-5 flex-wrap">
                  ...
                  <div className="flex gap-2 flex-wrap">
                    <h1
                      ...
                      className={`text-[10px] 280:text-xs font-medium text-nowrap px-3 py-[5px] rounded-2xl cursor-pointer border border-br-primary/20 ${filterType === "all" && "bg-bg-whitecolor/40 backdrop-blur-md"}`}
                    >
                      All
                    </h1>
                    <h1
                      ...
                      className={`text-[10px] 280:text-xs font-medium text-nowrap px-3 py-[5px] rounded-2xl cursor-pointer border border-br-primary/20 ${filterType === "movie" && "bg-bg-blueColor/40 backdrop-blur-md"}`}
                    >
                      Movies
                    </h1>
                    <h1
                      ...
                      className={`text-[10px] 280:text-xs font-medium text-nowrap px-3 py-[5px] rounded-2xl cursor-pointer border border-br-primary/20 ${filterType === "tv" && "bg-bg-yellowColor/40 backdrop-blur-md"}`}
                    >
                      TV Shows
                    </h1>
                  </div>
                    ...
                    {filteredResults?.map((content) => {
                      return (
                        <div
                          ...
                          className="w-full flex items-center justify-between gap-6 py-2 px-4 cursor-pointer transition-all ease-in duration-100 active:bg-bg-whitecolor/5"
                        >
                          ...
                          <h1
                            className={`text-[8px] 280:text-[10px] sm:text-xs font-normal py-[0.1rem] px-[0.4em] rounded-sm ${(content.media_type === "movie" && "bg-bg-blueColor/40") || (content.media_type === "tv" && "bg-bg-yellowColor/40")}`}
                          >
