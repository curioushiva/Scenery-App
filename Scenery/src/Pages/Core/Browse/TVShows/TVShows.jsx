...
const TVShows = () => {
  ...
  const { tvShowsCat, allGenres, tvShowsBGVideo } = useSelector(
    (store) => store.content,
  );
          ...
          <div className="relative z-10 w-full min-h-[75dvh] flex flex-col justify-between gap-10 navPadding">
            ...
            {tvShowsGenre.length > 0 ? (
              ...
              <div className="relative z-20 flex flex-row items-end gap-6 flex-wrap">
                ...
                >
                  ...
                  <svg
                    className={`w-3 transition-transform duration-300 ${isTvShowsGenreClicked ? "rotate-180" : "rotate-0"}`}
                    viewBox="8 10 8 4"
                    fill="currentColor"
                  >
                              ...
                              >
                                <div
                                  onClick={() => {
                                    setIsTvShowsGenreClicked(false);
                                    dispatch(
                                      addSelectedTvShowGenreIndex(index),
                                    );
                                    setIsBgVideoPlaying(false);
                                  }}
            ...
            <div className="max-w-md flex flex-col gap-4">
              <h1 className="text-3xl lg:text-4xl font-bold">
                {tvShowsBGVideo?.video?.title || tvShowsBGVideo?.video?.name}
              </h1>
              ...
              <div className="flex flex-col gap-4 350:flex-row">
                ...
                {tvShowsBGVideo?.video?.id && (
                  <div
                    onClick={() => mediaType(tvShowsBGVideo?.video)}
                                ...
                                <div className="absolute z-10 bottom-0 bg-bg-blackColor/90 w-full flex flex-col gap-2 px-2 py-2 opacity-0 group-hover:opacity-100 transition duration-200">
                                  <div className="flex justify-between items-center">
                                    ...
                                    >
                                      <div
                                        onClick={() =>
                                          saveProfileMedia(tvShow, "watchLater")
                                        }
                                        className="p-[0.1rem]"
                                      >
                                      ...
                                      <div
                                        onClick={() =>
                                          saveProfileMedia(tvShow, "favourite")
                                        }
                                        className="p-[0.1rem]"
                                      >
                                        {showSavedProfileMedia(
