                        ...
                        <div className='w-full flex items-center justify-start sm:justify-center'>
                            ...
                            <div className='w-full max-w-3xl flex flex-col gap-10'>
                                ...
                                <div className='w-full flex flex-col gap-2'>
                                    ...
                                    <p className='text-sm sm:text-base text-regular text-textcolor-secondary italic'>Delete your account</p>
                                </div>
                                {/* Delete account form */}
                                <div className='w-full flex flex-col gap-4'>
                                    ...
                                    <div className='flex flex-col gap-2'>
                                        ...
                                        <p className="hidden text-xs sm:text-sm text-[#ff8957] pl-2">Account could not be deleted</p>
                                    </div>
                                    {/* Buttons */}
                                    <div className='flex flex-col gap-2'>
                                        <button className="w-full px-5 py-2 text-sm sm:text-base font-medium rounded-sm bg-uicolor-primary cursor-pointer transition duration-100 ease-out active:scale-[0.95]">Delete</button>
