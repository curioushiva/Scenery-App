                        ...
                        <div className='w-full flex items-center justify-start sm:justify-center'>
                            ...
                            <div className='w-full max-w-3xl flex flex-col gap-10'>
                                ...
                                <div className='w-full flex flex-col gap-2'>
                                    ...
                                    <p className='text-sm sm:text-base text-regular text-textcolor-secondary italic'>Change the email associated with your account.</p>
                                </div>
                                {/* Email Form */}
                                <div className='w-full flex flex-col gap-4'>
                                    {/* Inputs */}
                                    <div className='flex flex-col gap-2'>
                                        <input className="w-full text-sm sm:text-base px-5 py-3 border border-white/10 rounded-sm bg-bgcolor-secondary placeholder-textcolor-secondary focus:outline focus:outline-white" type="text" placeholder="Email" />
                                        <p className="hidden text-xs sm:text-sm text-[#ff8957] pl-2">Invalid email address</p>
                                    </div>
                                    {/* Buttons */}
                                    <div className='flex flex-col gap-2'>
