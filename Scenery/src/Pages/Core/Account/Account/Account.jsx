        ...
        <div className="flex flex-col gap-8 pt-2">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col border border-br-secondary/15 rounded-2xl overflow-hidden divide-y divide-br-secondary/15">
              <Link
                to="/account/name"
                className="w-full flex items-center justify-between gap-5 py-4 lg:py-5 px-5 cursor-pointer transition-all ease-in duration-100 hover:bg-bg-whiteColor/5"
              >
          ...
          <div className="flex flex-col gap-4">
            ...
            <Link
              to="choose"
              className="flex flex-col border border-br-secondary/15 rounded-2xl overflow-hidden divide-y divide-br-secondary/15"
            >
