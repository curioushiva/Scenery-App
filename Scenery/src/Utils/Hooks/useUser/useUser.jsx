...
import { updateAccount, setIsUsersAvatarNumFetched, removeUser, } from "@/Utils/Redux/Slices/UserSlice/UserSlice";
import { setIsMediaFetched, addSavedMovies, addSavedTVShows } from "@/Utils/Redux/Slices/MediaSlice/MediaSlice";
    ...
    useEffect(() => {
        const unsubscribe = onAuthStateChanged(auth, (user) => {
            if (user) {
                ...
                dispatch(removeUser());
                const authRoutes = ['/signin', '/signup', '/about', '/privacy'];
                if (!authRoutes.includes(location.pathname)) {
                    navigate('/');
                }
            }
