import {
  SCENERY_API_IMG_POSTER_BASE_URL,
  SCENERY_API_IMG_HERO_BACKDROP_BASE_URL,
  SCENERY_API_IMG_HERO_POSTER_BASE_URL,
...
import NoProfile from "@/Assets/Images/Placeholders/NoProfile.png";
import NoProvider from "@/Assets/Images/Placeholders/NoProvider.png";
import NoStudio from "@/Assets/Images/Placeholders/NoStudio.png";
  ...
  return (
    <div className="absolute z-0 w-full h-[75dvh] min-h-100 overflow-hidden">
      <img
        ...
        src={`${SCENERY_API_IMG_HERO_BACKDROP_BASE_URL}${backdropPathUrl}`}
        alt="Background"
      />
      {/* Fades top & bottoms */}
  ...
  return (
    <div className="hidden flex-col shrink-0  880:flex 880:w-[18rem]">
      <img
        src={
          posterPathUrl
            ? `${SCENERY_API_IMG_HERO_POSTER_BASE_URL}${posterPathUrl}`
            : NoPoster
        }
        alt="Poster"
          ...
          <img
            src={
              regionalWatchProviderFirstValue?.[0]?.logo_path
                ? `${SCENERY_API_IMG_POSTER_BASE_URL}${regionalWatchProviderFirstValue?.[0]?.logo_path}`
                : NoProvider
            }
            alt="streamingLogo"
    ...
    <div className="w-full flex flex-col gap-5 880:flex-row 880:gap-10">
      ...
      <div className="w-full flex items-center gap-2 p-4 bg-bg-blackColor/40 [clip-path:polygon(12px_0,100%_0,100%_calc(100%-12px),calc(100%-12px)_100%,0_100%,0_12px)]">
        ...
        <div className="flex flex-col">
          ...
          <h2 className="text-base">{mediaStatus || "N/A"}</h2>
        </div>
      </div>
    </div>
  );
              ...
              return (
                ...
                >
                  <img
                    src={
                      cast?.profile_path
                        ? `${SCENERY_API_IMG_POSTER_BASE_URL}${cast?.profile_path}`
                        : NoProfile
                    }
                    alt="Cast"
                              ...
                              <img
                                src={
                                  review?.author_details?.avatar_path
                                    ? `${SCENERY_API_IMG_POSTER_BASE_URL}${review?.author_details?.avatar_path}`
                                    : NoProfile
                                }
                                alt="Profile"
                      ...
                      >
                        <div className="w-full h-13 bg-bg-whiteColor rounded-sm p-2 flex items-center justify-center overflow-hidden 460:max-w-28">
                          <img
                            src={
                              studio?.logo_path
                                ? `${SCENERY_API_IMG_POSTER_BASE_URL}${studio.logo_path}`
                                : NoStudio
                            }
                            alt="StudioLogo"
                          ...
                          return (
                            ...
                            >
                              <img
                                src={
                                  platform?.logo_path
                                    ? `${SCENERY_API_IMG_POSTER_BASE_URL}${platform?.logo_path}`
                                    : NoProvider
                                }
                                alt="ProvidersLogo"
                      ...
                      >
                        <div className="w-full h-13 bg-bg-whiteColor rounded-sm p-2 flex items-center justify-center overflow-hidden 460:max-w-28">
                          <img
                            src={
                              network?.logo_path
                                ? `${SCENERY_API_IMG_POSTER_BASE_URL}${network.logo_path}`
                                : NoStudio
                            }
                            alt="NetworksLogo"
                            className="max-w-full max-h-full object-contain"
                              ...
                              <img
                                src={
                                  season?.poster_path ||
                                    ...
                                    ? `${SCENERY_API_IMG_POSTER_BASE_URL}${season?.poster_path || mediaDetails?.poster_path}`
                                    : NoPoster
                                }
                                alt="SeasonPoster"
                            ...
                            <img
                              src={
                                mediaInfoSeriesLastEpisode?.still_path ||
                                  ...
                                  ? `${SCENERY_API_IMG_POSTER_BASE_URL}${mediaInfoSeriesLastEpisode?.still_path || mediaDetails?.backdrop_path}`
                                  : NoBackdrop
                              }
                              alt="SeasonPoster"
                              className="w-full h-full object-cover"
                            ...
                            <img
                              src={
                                mediaInfoSeriesNextEpisode?.still_path ||
                                  mediaDetails?.backdrop_path
                                  ? `${SCENERY_API_IMG_POSTER_BASE_URL}${mediaInfoSeriesNextEpisode?.still_path || mediaDetails?.backdrop_path}`
                                  : NoBackdrop
                              }
                              alt="SeasonPoster"
                              className="w-full h-full object-cover"
